    ...
    DimensionManager dimensionManager)
{
        ...
        where TDialog : ComponentBase
    {
        ...
        var options = CreateOptions(content, parameters, opened);
    ...
    private DialogOptions CreateOptions(object? content, DialogParameters parameters, TaskCompletionSource<IDialogInstance> opened)
    {
        var options = new DialogOptions
        {
            ...
            Data = parameters,
            Modal = parameters.Modal || parameters.PreventDismissOnOverlayClick,
